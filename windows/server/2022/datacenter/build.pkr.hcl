build {
  ...
  provisioner "powershell" {
    inline = [
      ...
      "cmd.exe /c C:/Windows/System32/WindowsPowerShell/v1.0/powershell.exe -File C:/Temp/Convert-WindowsEdition.ps1 -windowsEdition 'Microsoft Windows Server 2022 Datacenter'",
